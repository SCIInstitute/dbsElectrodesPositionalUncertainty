function [eL, eA1, eA2] = getElectrodeVectorsWithShaft(contactDir)
...
% Total length of four contacts including shaft is 13.5mm
eL = [0 0 0] + (13.5/2)*(contactDir/norm(contactDir));

...
function elecLims = xyzElectrodeLimitsWithShaft(electrodeCenter, eL, eA1, eA2)
...
[xLow,xMax] = elecXLimitsWithShaft(electrodeCenter, eL, eA1, eA2);

[yLow,yMax] = elecYLimitsWithShaft(electrodeCenter, eL, eA1, eA2);

[zLow,zMax] = elecZLimitsWithShaft(electrodeCenter, eL, eA1, eA2);

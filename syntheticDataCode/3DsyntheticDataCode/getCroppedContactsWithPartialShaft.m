% Orient DBS lead image along the trajectory specified by underlyingTraj
% and append it on both sides with a number of zero planes specified  by
% numPlanes
